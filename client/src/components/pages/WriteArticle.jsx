...
const WriteArticle = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      {/* ================= RIGHT COLUMN (SMALLER BOX) ================= */}
      <div className='w-full max-w-md p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-[350px]'>
        <div className='flex items-center gap-3'>
        ...
        <div className='flex-1 flex justify-center items-center'>
          <div className='text-sm flex flex-col items-center gap-4 text-gray-400 text-center'>
            ...
            <p>
              ...
              <span className='font-medium'>"Generate article" </span>
              to get started
            </p>
          </div>
        </div>
